...
On Line 102 there is error message. This is because there is an object missing. This could be fixed by adding: nCols <- dim(cleanDF)[2]
Afterwards i got an error saying there is a function missing knn. So i added library(class) to fix it. 
When inspecting the code i found a typo/error in the order of the cleanDF. I changed it back. 